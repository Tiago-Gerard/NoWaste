...
public class ServiceCreateOffer {
    ...
    public static void createUser(ServiceCreateOffer.Callbacks callback,String description,String datePeremption,String idType,double longitude,double latitude,String path,String idUtilisateur){
