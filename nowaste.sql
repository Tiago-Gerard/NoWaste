...
--
-- Client :  localhost
-- Généré le :  Lun 04 Juin 2018 à 14:42
...
(1, 'Albadri', 'Jamz', '078 949 87 97', 'alabdri@moliere.ch');
...
--
ALTER TABLE `Offre`
  MODIFY `idOffre` int(4) NOT NULL AUTO_INCREMENT COMMENT 'identifiant de l''offre', AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `Type`
  MODIFY `idType` int(1) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `Offre`
  ...
  ADD CONSTRAINT `Offre_ibfk_2` FOREIGN KEY (`idPosition`) REFERENCES `Position` (`idPosition`) ON DELETE NO ACTION ON UPDATE NO ACTION,
